...
const navigate = useNavigate()
  ...
  return (
    <div className="min-h-screen bg-white text-black flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-md p-8 backdrop-blur-md border border-neutral-800 rounded-2xl">
        ...
        <h1 className="text-2xl font-semibold text-white text-center mb-6">
         ...
         <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input
            ...
            className="w-full border border-neutral-800 px-4 py-3 text-black rounded-md outline-none focus:border-[#00ff00] placeholder-neutral-500"
          />
